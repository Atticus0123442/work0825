...
CREATE TABLE `users` (
  ...
  `gender` enum('M','F','NB') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'NB',
  `weight` decimal(5,2) DEFAULT NULL,
  `height` decimal(5,2) DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `classes` enum('S','T','NB') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES (0,'Atticus',24,'M',80.00,183.00,'2025-08-22 14:39:45','1234','1234',NULL,'大同區');
